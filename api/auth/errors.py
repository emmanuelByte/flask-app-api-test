...
TEMPLATE_DOES_NOT_EXIST_ERROR_CODE = 'template_not_exist'
...
TemplateDoesNotExistError = (restify(False, "Template doesn't exist", error_code=TEMPLATE_DOES_NOT_EXIST_ERROR_CODE), 404)
